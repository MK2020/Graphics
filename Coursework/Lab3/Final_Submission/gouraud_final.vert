...
//reflecion vector
	vec3 reflection = -1 * reflect(lightvector, vertexInOut.normal_camSpace);
	//vec3 reflection = 2 * max(dot(vertexInOut.normal_camSpace, lightvector),0)
				//	*vertexInOut.normal_camSpace - lightvector;
